...
def parse_options():
   ...
   """
    ...
    group.add_argument('-j', '--json', dest='json', help='Json file with a list of datapoints to process', default=None)
    ...
    group.add_argument('-s', '--status', dest='pstatus',
        help=' Status of the pickle file (print object in a readable form)',
        action='store_true',
        default=False,
    )

    group.add_argument('-c', '--clean', dest='pclean',
